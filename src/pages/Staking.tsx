        ...
        <div className={styles.container}>
            <div className={styles.leftWrapper}>
                <h2 className={styles.title}>
                    <span>Stake</span> your $DUNES to join the best{" "}
                    <span>IDOs</span>
                </h2>
                <button className={styles.leftButton}>buy $DUNES</button>
                <div className={styles.warningWrapper}>
                    <img src={warningIcon} alt="warning image" />
                    Legacy $SFUND staking and farming pools are closed. The new
                    pools are open with Seed Staking Boosters. You can deposit
                    now.
                </div>
            ...
            <div className={styles.rightWrapper}>
                <div className={styles.right}>
                    ...
                    <div className={styles.middleInfoWrapper}>
                        ...
                        <div
                            className={`${styles.infoText} ${styles.middleInfoText}`}
                        >
